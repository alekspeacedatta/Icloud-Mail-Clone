...
const InboxView = () => {
  ...
  return (
    <div className='bg-zinc-900 w-1/3 flex flex-col gap-4 pt-4  overflow-hidden border-r border-r-[#3c3c3e]'>
        <div className="flex flex-col leading-none px-4 gap-1">
            <h2 className="text-zinc-100 text-2xl font-semibold">{selectedTabName}</h2>
